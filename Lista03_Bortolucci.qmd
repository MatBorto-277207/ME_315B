...
ORDER BY DNO, SALARY
```
Na primeira só seleciona os dados DNO e SALARY da tabela, no segundo os valores repetidos são removidos e na terceira os valores repetidos são removidos e os valores restantes são ordenados em DNO em primeiro grau e SALARY em segundo grau
...
```
A primeira e a terceira sim, mas a segunda é diferente
